...
public interface ISettingDescriptorJsonProvider
{
    ...
    /// <summary>
    /// Gets a strongly typed <see cref="SettingDescriptor"/> with the specified setting name and <see cref="JsonValueKind"/>.
    /// </summary>
    /// <param name="settingName">The name of the setting.</param>
    /// <param name="jsonValueKind">The <see cref="JsonValueKind"/> value.</param>
    /// <returns>The <see cref="SettingDescriptor"/> instance.</returns>
    SettingDescriptor GetDescriptor(string settingName, JsonValueKind jsonValueKind);
}
