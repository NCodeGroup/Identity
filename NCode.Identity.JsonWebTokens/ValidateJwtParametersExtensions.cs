...
public static class ValidateJwtParametersExtensions
{
    ...
    extension(ValidateJwtParameters parameters)
    {
        /// <summary>
        ...
        /// <returns>The <see cref="ValidateJwtParameters"/> instance for method chaining.</returns>
        public ValidateJwtParameters AddValidator(ValidateJwtAsync validator)
        {
        ...
        /// <returns>The <see cref="ValidateJwtParameters"/> instance for method chaining.</returns>
        public ValidateJwtParameters ValidateClaim(
            string claimName,
            bool usePayload,
