...
/// appropriate display.
/// </summary>
[TypeConverter(typeof(OpenIdEnumConverter<DisplayType>))]
public enum DisplayType
{
    ...
    /// </summary>
    [OpenIdLabel(OpenIdConstants.DisplayTypes.Page)]
    Page,
    ...
    /// </summary>
    [OpenIdLabel(OpenIdConstants.DisplayTypes.Popup)]
    Popup,
    ...
    /// </summary>
    [OpenIdLabel(OpenIdConstants.DisplayTypes.Touch)]
    Touch,
    ...
    /// type display.
    /// </summary>
    [OpenIdLabel(OpenIdConstants.DisplayTypes.Wap)]
    Wap
}
