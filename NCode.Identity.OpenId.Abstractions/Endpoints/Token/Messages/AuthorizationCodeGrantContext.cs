...
/// <summary>
/// Contains the information about the request that the authorization server will use to issue tokens using the <c>Authorization Code</c> grant type.
/// </summary>
...
public record struct AuthorizationCodeGrantContext(
