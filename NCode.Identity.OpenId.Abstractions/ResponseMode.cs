...
/// Endpoint.
/// </summary>
[TypeConverter(typeof(OpenIdEnumConverter<ResponseMode>))]
public enum ResponseMode
{
    ...
    /// </summary>
    [OpenIdLabel(OpenIdConstants.ResponseModes.Query)]
    Query,
    ...
    /// <c>redirect_uri</c> when redirecting back to the Client.
    /// </summary>
    [OpenIdLabel(OpenIdConstants.ResponseModes.Fragment)]
    Fragment,
    ...
    /// </summary>
    [OpenIdLabel(OpenIdConstants.ResponseModes.FormPost)]
    FormPost
}
