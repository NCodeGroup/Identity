...
public interface IContinueProvider
{
    ...
    /// <returns>The <see cref="ValueTask"/> that represents the asynchronous operation, containing the <see cref="ReadOnlyEndpointDisposition"/> for the operation.</returns>
