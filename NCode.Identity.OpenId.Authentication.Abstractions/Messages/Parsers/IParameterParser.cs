...
using ParameterDescriptor = NCode.Identity.OpenId.Authentication.Messages.Parameters.ParameterDescriptor;

namespace NCode.Identity.OpenId.Authentication.Messages.Parsers;

/// <summary>
/// Provides the ability parse and load <see cref="IParameter{T}"/> values of a specific type.
/// </summary>
