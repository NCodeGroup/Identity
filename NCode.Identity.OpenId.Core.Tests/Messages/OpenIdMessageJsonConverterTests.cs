...
public class OpenIdMessageJsonConverterTests : IDisposable
{
    ...
    {
        var converter = new OpenIdMessageJsonConverter<OpenIdMessage>(MockOpenIdEnvironment.Object);
    ...
    public void LoadParameter_GivenJsonParser_WhenSuccess_ThenParameterAdded()
    {
        ...
        var converter = new OpenIdMessageJsonConverter<OpenIdMessage>(environment);
    ...
    private static Parameter ReadJsonValid(ref Utf8JsonReader reader, OpenIdEnvironment environment, ParameterDescriptor descriptor, JsonSerializerOptions options)
    {
        Assert.True(reader.Read());
    ...
    private static Parameter ReadJsonThrows(ref Utf8JsonReader reader, OpenIdEnvironment environment, ParameterDescriptor descriptor, JsonSerializerOptions options)
    {
    ...
    public void Read_GivenEndObject_ThenReturnEmptyObject()
    {
        ...
        Assert.Same(MockOpenIdEnvironment.Object, message.OpenIdEnvironment);
    ...
    {
        var converter = new OpenIdMessageJsonConverter<TestOpenIdMessage>(MockOpenIdEnvironment.Object);
    ...
    {
        var context = MockOpenIdEnvironment.Object;
        ...
        message.Initialize(context, [parameter]);
    ...
    public void Serialize_GivenUnknownProperties_ThenValid()
    {
        ...
        var inputMessage = TestOpenIdMessage.Load(MockOpenIdEnvironment.Object, properties);
    ...
    public void Serialize_GivenNestedObject_ThenValid()
    {
        ...
        var inputMessage = TestOpenIdMessageWithKnownParameter.Load(MockOpenIdEnvironment.Object, Array.Empty<Parameter>());
        var typeNameOfMessage = inputMessage.GetType().AssemblyQualifiedName;
