...
public class AuthorizationRequestObjectOptions
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the <c>request_uri</c> parameter in an <c>OAuth</c> or <c>OpenID Connect</c>
    /// authorization message is supported or not.
    /// </summary>
    public bool RequestUriEnabled { get; set; }

    /// <summary>
    /// Gets or sets the maximum allowable length for the <c>request_uri</c> parameter in an <c>OAuth</c> or <c>OpenID Connect</c>
