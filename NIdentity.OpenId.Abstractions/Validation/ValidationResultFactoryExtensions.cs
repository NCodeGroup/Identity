...
namespace NIdentity.OpenId.Validation
{
    public static class ValidationResultFactoryExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValidationResult<TValue> InvalidRequest<TValue>(this IValidationResultFactory factory, string errorDescription, string errorCode = OpenIdConstants.ErrorCodes.InvalidRequest)
            => factory.BadRequest<TValue>(errorCode, errorDescription);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValidationResult<TValue> MissingParameter<TValue>(this IValidationResultFactory factory, string key, string errorCode = OpenIdConstants.ErrorCodes.InvalidRequest)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValidationResult<TValue> InvalidParameterValue<TValue>(this IValidationResultFactory factory, string key, string errorCode = OpenIdConstants.ErrorCodes.InvalidRequest)
        ...
        public static ValidationResult<TValue> UnauthorizedClient<TValue>(this IValidationResultFactory factory)
            => factory.BadRequest<TValue>(OpenIdConstants.ErrorCodes.UnauthorizedClient, "The client is not allowed to request an access token using this authentication type.");
    }
}
