...
namespace NIdentity.OpenId.Validation
{
    public static class ValidationResultFactoryExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValidationResult InvalidRequest(this IValidationResultFactory factory, string errorDescription, string errorCode = OpenIdConstants.ErrorCodes.InvalidRequest)
            => factory.BadRequest(errorCode, errorDescription);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValidationResult MissingParameter(this IValidationResultFactory factory, string key, string errorCode = OpenIdConstants.ErrorCodes.InvalidRequest)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValidationResult InvalidParameterValue(this IValidationResultFactory factory, string key, string errorCode = OpenIdConstants.ErrorCodes.InvalidRequest)
        ...
        public static ValidationResult UnauthorizedClient(this IValidationResultFactory factory)
            => factory.BadRequest(OpenIdConstants.ErrorCodes.UnauthorizedClient, "The client is not allowed to request an access token using this authentication type.");
    }
}
