...
{
    internal class SingleStringParser : OpenIdParameterParser<string>
    {
        public static SingleStringParser Default = new();
        ...
        public override bool TryParse(string parameterName, OpenIdStringValues stringValues, out ValidationResult<string> result)
        {
            ...
            {
                result = ValidationResult.Factory.MissingParameter<string>(parameterName);
                return false;
            }
            ...
            result = ValidationResult.Factory.Success(stringValues[0].Value);
            return true;
        }
    }
}
